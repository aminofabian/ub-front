...
export function shellPageTitle(pathname: string): string {
  ...
  const exact: Record<string, string> = {
    ...
    [APP_ROUTES.inventoryStock]: "Home",
    ...
    [APP_ROUTES.purchasingAddSupplies]: "Records",
    ...
    [APP_ROUTES.purchasingRecordPayment]: "Advance / deposit",
    ...
    [APP_ROUTES.expenses]: "Expenses & profit",
    [APP_ROUTES.profitPocketing]: "Pocketing",
