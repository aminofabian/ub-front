export const APP_ROUTES = {
  ...
  superAdminAdoptions: "/super-admin/adoptions",
  ...
  superAdminPlatformDesktopLicenses: "/super-admin/platform/desktop-licenses",
  superAdminPlatformLoadTest: "/super-admin/platform/load-test",
  business: "/business",
  ...
  supplierPortalShops: "/supplier-portal/shops",
  supplierPortalPayments: "/supplier-portal/payments",
  ...
  supplierPortalTeam: "/supplier-portal/team",
  supplierPortalMessages: "/supplier-portal/messages",
  ...
  inventoryStockTakeMyStats: "/inventory/stock-take/my-stats",
...
export const API_ROUTES = {
  ...
  supplierPortalAuthClaimConfig: "/api/v1/supplier-portal/auth/claim/config",
  ...
  supplierPortalAuthClaimVerifyInvite: "/api/v1/supplier-portal/auth/claim/verify-invite",
  ...
  supplierPortalHubShops: "/api/v1/supplier-portal/hub/shops",
  supplierPortalProducts: "/api/v1/supplier-portal/products",
  supplierPortalOrders: "/api/v1/supplier-portal/orders",
  supplierPortalPayments: "/api/v1/supplier-portal/payments",
  ...
  supplierPortalTeam: "/api/v1/supplier-portal/team",
  supplierPortalMessages: "/api/v1/supplier-portal/messages",
  ...
  superAdminMe: "/api/v1/super-admin/me",
