...
export function KioskLogoMark({
  ...
  return (
    <span
      className={cn(
        "kiosk-logo-mark relative inline-flex shrink-0 overflow-hidden rounded-[0.32em] ring-1 ring-inset ring-white/25 transition-transform duration-300 group-hover:-translate-y-px",
        shellClass,
        className,
      )}
