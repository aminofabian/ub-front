...
export function MizuSpringsProduct({
  slug,
  item,
}: {
  slug: string;
  ...
  return (
    <div
      className={cn(styles.root, styles.body, mizuSpringsFontVariables, styles.pdp)}
      ...
      <div className={styles.pdpWrap}>
        ...
        <div className={styles.pdpGrid}>
          ...
          <section className={styles.pdpInfo}>
            <span className={styles.pdpBadge}>Premium purified</span>
            ...
            {showPrice ? (
              ...
              <div className={styles.pdpUnavailable}>
                {hasMultipleOptions
                  ? "Pick a size above to add this to your bag."
                  : "Ask on WhatsApp — we will confirm what we can bottle for you."}
              </div>
            )}

            <div className={styles.pdpNote}>
              <h3 className={styles.pdpNoteTitle}>Delivery note</h3>
              <p className={styles.pdpNoteHint}>
                Gate code, landmark, or custom label text — we will confirm on
                WhatsApp.
              </p>
              <textarea
