...
const ITEM_ICON_BY_HREF: Partial<Record<string, LucideIcon>> = {
  ...
  [APP_ROUTES.businessThemes]: LayoutTemplate,
  ...
  [APP_ROUTES.shifts]: Clock,
  [APP_ROUTES.paymentsSettings]: CreditCard,
  [APP_ROUTES.paymentsDayLedger]: Receipt,
  [APP_ROUTES.expenses]: Scale,
  [APP_ROUTES.profitPocketing]: CalendarDays,
  [APP_ROUTES.fixedCosts]: Building2,
  [APP_ROUTES.paymentsKioskPay]: Wallet,
  [APP_ROUTES.airtime]: Signal,
  [APP_ROUTES.onlineAirtime]: Smartphone,
  [APP_ROUTES.creditsOnTab]: CreditCard,
  [APP_ROUTES.customers]: Users,
  [APP_ROUTES.customerSegments]: Filter,
...
const RAIL_SHORT_LABEL_BY_HREF: Partial<Record<string, string>> = {
  ...
  [APP_ROUTES.purchasingAddSupplies]: "Delivery",
  [APP_ROUTES.order]: "Order",
  [APP_ROUTES.orderReceive]: "Confirm",
  [APP_ROUTES.purchasingApAging]: "Unpaid",
  [APP_ROUTES.purchasingRecordPayment]: "Pay",
  [APP_ROUTES.purchasingIntelligence]: "Compare",
  [APP_ROUTES.paymentsDayLedger]: "Ledger",
  [APP_ROUTES.expenses]: "Profit",
  [APP_ROUTES.profitPocketing]: "Pocket",
  [APP_ROUTES.fixedCosts]: "Fixed",
  [APP_ROUTES.paymentsKioskPay]: "Kiosk Pay",
  [APP_ROUTES.airtime]: "Airtime",
  [APP_ROUTES.onlineAirtime]: "Online",
...
function SubNavPanel({
  ...
  return (
    ...
    >
        ...
        className={cn(
          ...
          compact
            ...
            : section.hidePanelHeading
              ...
              : "items-start justify-between gap-3 px-3 py-3",
        )}
      >
        {compact ? (
          <button
          ...
          <>
            ...
            <button
              ...
              className="flex size-7 shrink-0 items-center justify-center rounded-md text-muted-foreground outline-none transition-colors hover:bg-muted/70 hover:text-foreground focus-visible:ring-2 focus-visible:ring-primary/30"
            >
      ...
      {showSearch ? (
        <div className="border-b border-border/50 bg-muted/35 px-3 py-2.5">
          <label className="relative block">
            ...
            <Input
              ...
              className="h-8 border-border/80 bg-background pl-8 text-xs shadow-none"
            />
          </label>
        </div>
      ) : null}
      ...
      <nav
        className={cn(
          ...
          compact ? "gap-1 p-1.5" : "gap-1 px-2 py-2.5",
        )}
