...
/** Six shortcuts, three across — the board a shop navigates with. */
        ...
        {tiles.map((link) => {
          ...
          return (
            <Link
              ...
              title={link.hint}
              className={cn(
                "group flex min-h-[4.25rem] flex-col items-center justify-center gap-1.5 rounded-xl border border-[color-mix(in_srgb,#141414_7%,transparent)] bg-[#FBFCFB] px-1.5 py-2 text-center transition-colors",
