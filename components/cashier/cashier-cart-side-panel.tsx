...
export function CashierCartSidePanel({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "pos-market-receipt flex h-full min-h-0 flex-1 flex-col overflow-hidden rounded-sm border border-[color-mix(in_srgb,var(--pos-ink,#1c1915)_12%,transparent)]",
          "dark:border-border/60",
          pulse && "animate-pos-cart-pulse ring-2 ring-[color-mix(in_srgb,var(--pos-primary)_40%,transparent)]",
        )}
      >
        <div className="flex shrink-0 items-start justify-between gap-2 border-b border-dashed border-[color-mix(in_srgb,var(--pos-ink,#1c1915)_14%,transparent)] px-3 py-2 dark:border-border/50">
          ...
          <span className="inline-flex size-8 items-center justify-center rounded-md border border-[color-mix(in_srgb,var(--pos-ink,#1c1915)_12%,transparent)] bg-[color-mix(in_srgb,var(--pos-primary)_10%,transparent)] text-[var(--pos-primary)]">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto overscroll-y-contain px-2 py-1">
          {lines.length === 0 ? (
            <div className="flex h-full min-h-0 flex-col justify-between px-3 py-3">
              <div className="space-y-2.5 border-b border-dashed border-[color-mix(in_srgb,var(--pos-ink,#1c1915)_12%,transparent)] pb-3 dark:border-border/40">
                {[0, 1, 2].map((i) => (
                  <div
                    key={i}
              ...
              <div className="pt-3 text-center">
                <p className="pos-market-section-label text-base text-foreground/80">
                  Ready when you are
                </p>
        ...
        <div className="shrink-0 border-t border-dashed border-[color-mix(in_srgb,var(--pos-ink,#1c1915)_14%,transparent)] bg-[color-mix(in_srgb,var(--pos-paper,#f1ece3)_40%,transparent)] px-3 py-2.5 dark:border-border/50 dark:bg-muted/10">
          <div className="mb-2 flex items-end gap-2">
            ...
            <span
              ...
              className="pos-tile-line-total inline-flex items-baseline gap-1 text-xl font-bold tabular-nums tracking-tight text-[var(--pos-primary)]"
            >
