      ...
      <div className="relative mx-auto max-w-lg px-4 py-16" style={themeStyle}>
        ...
        <div className="relative">
          ...
          <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
            Sign in to reveal pickup trails, wallet starlight, loyalty dust, and the tab you floated with friendly staff.
          </p>
          <dl className="mt-10 space-y-3 rounded-[1.4rem] border border-border/60 bg-card/80 p-6 text-sm shadow-sm backdrop-blur">
            <div className="flex justify-between gap-4 border-b border-dashed pb-4">
              ...
              <dd className="font-mono text-foreground">{fmtMoney(0, peekCurrency ?? "USD")}</dd>
            </div>
            <div className="flex justify-between gap-4 border-b border-dashed pb-4">
  ...
  if (state === "error") {
    return (
      <div className="mx-auto max-w-xl px-4 py-14">
        <h1 className="font-heading text-2xl font-bold tracking-tight text-foreground">Your account</h1>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <Button variant="ghost" className="rounded-xl gap-2 text-destructive hover:text-destructive" onClick={() => void onLogout()}>
