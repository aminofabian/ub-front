  ...
  return (
    <div className="min-h-screen bg-background px-4 py-8">
      <div className="mx-auto max-w-3xl">
        ...
        <h1 className="mt-6 text-2xl font-semibold tracking-tight">Your cart</h1>
        <p className="mt-2 text-sm text-muted-foreground">Branch prices from your storefront catalog.</p>
