...
export const mktSearch =
  "h-10 w-full min-w-0 rounded-lg border border-border/70 bg-background pl-10 pr-9 text-sm " +
...
export const mktTile =
  "group relative flex h-full flex-col overflow-hidden rounded-lg border border-border/55 " +
...
export const mktChip =
  "inline-flex shrink-0 snap-start items-center rounded-md border border-[color-mix(in_srgb,var(--pos-ink,#1c1915)_14%,transparent)] " +
  ...
  "transition-colors hover:border-[color-mix(in_srgb,var(--pos-ink,#1c1915)_28%,transparent)] hover:text-[var(--pos-ink,#1c1915)]";
...
export const mktPosShell =
  "overflow-hidden rounded-xl border border-[color-mix(in_srgb,var(--pos-ink,#1c1915)_12%,transparent)] " +
  "bg-[color-mix(in_srgb,var(--card)_92%,#f7f3eb)] " +
  "shadow-[0_1px_0_color-mix(in_srgb,var(--pos-ink,#1c1915)_6%,transparent),0_16px_48px_-28px_color-mix(in_srgb,var(--pos-ink,#1c1915)_22%,transparent)]";
...
export const mktPosAccentBar =
  "absolute inset-y-0 left-0 w-1 rounded-l-xl bg-[var(--pos-primary,#0f766e)]";

export const mktPosHeader =
  "flex h-8 shrink-0 items-center justify-between rounded-t-lg bg-[var(--pos-primary,#0f766e)] " +
  "px-2.5 text-[10px] font-bold uppercase tracking-[0.14em] text-[var(--pos-primary-ink,#fff)]";

export const mktPosSearch =
  "h-9 w-full rounded-lg bg-transparent pl-8 pr-9 text-[13px] outline-none " +
  "placeholder:text-muted-foreground/50";
...
export const mktPosTile =
  ...
  "hover:shadow-[0_4px_16px_-6px_color-mix(in_srgb,var(--pos-ink,#1c1915)_18%,transparent)]";

export const mktPanel =
  "flex h-full min-h-0 flex-col overflow-hidden rounded-xl border border-border/60 bg-card";

export const mktBtn =
  "inline-flex h-11 items-center justify-center gap-2 rounded-lg border border-foreground " +
...
export const mktBtnGhost =
  "inline-flex h-11 items-center justify-center gap-2 rounded-lg border border-border " +
