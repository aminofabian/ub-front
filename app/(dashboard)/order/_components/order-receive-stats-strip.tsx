        ...
        <div className="flex items-end justify-between gap-3">
          ...
          {!loading && basketActive ? (
            <Link
              ...
              className="inline-flex shrink-0 items-center gap-1.5 rounded-full border border-[color-mix(in_srgb,var(--pos-primary,#0f766e)_25%,transparent)] bg-[color-mix(in_srgb,var(--pos-primary,#0f766e)_10%,transparent)] px-3 py-1.5 text-[10px] font-bold uppercase tracking-[0.08em] text-[var(--pos-primary,#0f766e)] transition hover:bg-[color-mix(in_srgb,var(--pos-primary,#0f766e)_16%,transparent)]"
            >
