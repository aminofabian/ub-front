  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <Card className="overflow-hidden border-border/70 p-0 shadow-sm lg:col-span-2">
          <CardHeader className="flex flex-row items-start justify-between gap-4 border-b border-border/60 px-6 pb-4 pt-6">
            <div>
